        ...
        <div class="w-full">
            ...
            <form class="space-y-4" method="post" action="/barang/update/{{$data->id}}" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="text" name="stock" value="{{$data->stock}}" class="w-full mt-1 border border-gray-300 rounded-xl px-3 py-2" placeholder="Masukan Stock..">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="deskripsi" value="{{$data->deskripsi}}" class="w-full mt-1 border border-gray-300 rounded-xl px-3 py-2" placeholder="Masukan deskripsi..">
                </div>
