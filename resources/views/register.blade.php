       ...
       <div>
        ...
        <div class="bg-white rounded-3xl shadow-lg flex max-w-5xl w-full overflow-hidden">
            ...
            <div class="w-full md:w-1/2 p-10 flex flex-col justify-center">
                ...
                <p class="text-sm text-center text-gray-500 mt-6">Sudah punya akun terdaftar? <a href="/login"
                        class="text-teal-600 hover:underline">Sign In</a></p>
            </div>

            <!-- Right Side (Image) -->
            <div class="hidden md:block w-1/2 bg-gradient-to-tr from-teal-500/70 to-pink-500/70 relative h-screen">
                <img src="https://images.unsplash.com/photo-1559056961-1f4dbbf9d36a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
