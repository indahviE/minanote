                ...
                <table class="min-w-full text-sm text-left">
                    ...
                    @endif
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2">
                                <div class="font-medium">{{$data->kelayakan}}</div>
                            </td>
                            <td class="px-4 py-2">
                            ...
                            <td class="px-4 py-2">
                                <div class="flex gap-2">
                                    <a href="/barang/update/{{$data->id}}" class="rounded-md bg-teal-600 py-0.5 px-2.5 border border-transparent text-sm text-white transition-all shadow-sm">
                                        Modify Data
                                    </a>
